...
export class DatabaseStorage implements IStorage {
  ...
  async getCategoriesWithStats(): Promise<Array<Category & {
    ...
    const results = await db
      .select({
        ...
        isAiCategory: categories.isAiCategory,
  ...
  async getArticles(filters?: {
    ...
    const results = await db
      .select({
        ...
        smartSummary: articles.smartSummary,
    ...
    return results.map((r) => ({
      ...
      isAiGeneratedImage: r.isAiGeneratedImage,
      aiImageModel: r.aiImageModel,
      aiImagePrompt: r.aiImagePrompt,
      isAiGeneratedThumbnail: r.isAiGeneratedThumbnail,
      aiThumbnailModel: r.aiThumbnailModel,
      aiThumbnailPrompt: r.aiThumbnailPrompt,
      ...
      credibilityAnalysis: r.credibilityAnalysis,
      credibilityLastUpdated: r.credibilityLastUpdated,
      source: r.source,
  ...
  async getFeaturedArticle(userId?: string): Promise<ArticleWithDetails | undefined> {
    ...
    return {
      ...
      imageFocalPoint: result.imageFocalPoint,
      isAiGeneratedImage: result.isAiGeneratedImage,
      aiImageModel: result.aiImageModel,
      aiImagePrompt: result.aiImagePrompt,
      isAiGeneratedThumbnail: result.isAiGeneratedThumbnail,
      aiThumbnailModel: result.aiThumbnailModel,
      aiThumbnailPrompt: result.aiThumbnailPrompt,
      categoryId: result.categoryId,
      authorId: result.authorId,
      reporterId: result.reporterId,
      articleType: result.articleType,
      ...
      hideFromHomepage: result.hideFromHomepage,
      ...
      credibilityLastUpdated: result.credibilityLastUpdated,
      source: result.source,
      sourceMetadata: result.sourceMetadata,
      sourceUrl: result.sourceUrl,
      verifiedBy: result.verifiedBy,
      ...
      author: result.reporter_id || result.author_id ? {
        id: result.reporter_id || result.author_id,
        name: result.reporter_name || result.author_name,
        email: result.reporter_email || result.author_email,
        image: result.reporter_image || result.author_image,
        role: result.author_role,
      } : undefined,
    };
  }
  ...
  async getHeroArticles(): Promise<ArticleWithDetails[]> {
    ...
    return results.map((r) => ({
      ...
      storyTitle: r.story_title || undefined,
    }));
  }
