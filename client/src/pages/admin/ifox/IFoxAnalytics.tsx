      ...
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className={`flex items-center gap-1 px-2 py-1 rounded-full ${
            growth >= 0 ? 'bg-green-500/20 text-green-300' : 'bg-red-500/20 text-red-300'
          }`}>
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <Select value={timeRange} onValueChange={(v: any) => setTimeRange(v)}>
                  <SelectTrigger className="w-[180px] bg-slate-800/70 border-white/30 text-white" data-testid="select-time-range">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                ...
                >
                  ...
                  />
                  <span className="text-xs font-medium text-green-400">AI Analytics</span>
                    ...
                    <div className="space-y-3">
                      {topArticles.slice(0, 5).map((article, index) => (
                        <motion.div
                          ...
                          className="p-3 rounded-lg bg-slate-800/50 hover:bg-slate-800/70 transition-all cursor-pointer border border-white/20"
              ...
              <Card className="bg-gradient-to-br from-slate-800/70 to-slate-900/50 border-white/30 backdrop-blur-lg">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="p-4 rounded-lg bg-gradient-to-br from-pink-500/20 to-rose-500/20 border border-pink-500/30">
