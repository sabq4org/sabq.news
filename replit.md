...
- Enhanced SEO and Social Sharing: Added comprehensive Open Graph and Twitter Card meta tags to client/index.html for proper homepage sharing on WhatsApp/Facebook/Twitter with logo, title, description, and image dimensions. Article pages already have dynamic meta tags via ArticleDetail.tsx. Note: Client-side meta tag updates (SPA) may not be read by WhatsApp/Facebook crawlers - SSR or prerendering service recommended for production.
