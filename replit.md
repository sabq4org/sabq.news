...
-   **AI Comment Moderation System:** Automated comment analysis using GPT-4o-mini with classification (safe/flagged/spam/harmful), automatic status updates, admin dashboard at `/admin/comments/moderation` with metrics, filters, and bulk actions. Background processing ensures non-blocking comment creation.
